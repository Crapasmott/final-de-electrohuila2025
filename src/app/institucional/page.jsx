    ...
    const sections = [
        ...
        },
        {
            ...
            items: [
                ...
                { id: 'etica-cumplimiento', title: 'Ética y Cumplimiento', url: '/institucional/etica-cumplimiento' },
                { id: 'transparencia', title: 'Transparencia y Acceso a la Información Pública', url: '/institucional/ley-de-transparencia' },
            ...
            <div className="cta" style={{
                ...
                <div className="container">
                    ...
                    <p style={{ fontSize: '18px', marginBottom: '30px', maxWidth: '700px', margin: '0 auto 30px' }}>
                        Nuestro equipo está disponible para asistirte con cualquier consulta adicional sobre nuestra empresa.
                    </p>
                    <Link
                        href="/contacto"
                        style={{
