                ...
                <div className="container">
                    <div className="mission-vision-cards">
                        <div className="mv-card">
                            <h3>Misión</h3>
                            <p>Transmitimos buena energía, generamos confianza y distribuimos bienestar.</p>
                        </div>
                        <div className="mv-card">
                            <h3>Visión</h3>
                            <p>Para 2034, la ELECTRIFICADORA DEL HUILA S.A. E.S.P. será un motor del desarrollo productivo regional, destacándose por su generación sostenible, distribución inteligente y comercialización digital de energía. Con un portafolio diversificado de servicios de valor agregado, impulsará la electrificación de múltiples actividades en su área de influencia.</p>
                        </div>
                    </div>
                </div>
            </section>
